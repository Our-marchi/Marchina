...
const AllProducts: React.FC = () => {
  ...
  interface MyJwtPayload extends JwtPayload {
    role: string; // Replace 'string' with the actual type of your role
  }
...
//     if (token) {
//       try {
//         const decodedToken6 = jwt_decode<MyJwtPayload>(token);
                ...
                <div key={product.productid} className="relative flex flex-col items-start bg-white rounded-lg shadow-lg overflow-hidden">
                  <div className="relative w-full h-64 bg-neutral-100 rounded">
                    ...
                    <div className="absolute top-2 right-2 flex gap-2">
                      ...
                      <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-md">
                        {/* <FaEye onClick={() => router.push('/Product', { state: { product: product } })} className="text-black" /> */}
                      </div>
                    </div>
                  </div>
